            ...
            <div className="container py-5">
                <div className="row">
                    <div className="col-md-12 text-center">
                        ...
                        <Link to={"/"} className="btn fondoNaranja">Quiero Volver a la Página Principal</Link>
                    </div>
                </div>
            </div>
        )
                        ...
                        <tbody>
                            {cart.map(item => (
                                <tr key={item.id}>
                                    ...
                                    <td className="text-end align-middle"><Link onClick={() => {removeItem(item.id)}} title="Eliminar Producto"><img src={"images/trash3.svg"} alt={"Eliminar Producto"} width={24} /></Link></td>
                                </tr>
                            ))}
                            <tr>
                                <td colSpan={2}>&nbsp;</td>
